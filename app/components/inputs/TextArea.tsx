  ...
  return (
    <div className="relative w-full">
      <textarea
        ...
        placeholder=""
        className={`peer w-full max-h-[150px] min-h-[150px] rounded-md border-2 bg-white p-4 pt-6 font-light outline-none transition disabled:cursor-not-allowed disabled:opacity-70 ${
          errors[id]
